...
class TipoActivo(models.Model):
    ...
    serie = models.CharField(max_length=50, null=False, blank=False, unique=True, verbose_name="Nro de serie")
...
class Software(models.Model): 
    ...
    id_activo_software= models.OneToOneField("TipoActivo", verbose_name=_("id_activo_software"), on_delete=models.CASCADE, related_name="id_activo_software")
    

class Hardware(models.Model): 
    
    diligenciado = models.BooleanField(default = False)
    modelo_board = models.CharField(max_length=50, null=False, blank=False, verbose_name= "Modelo Board")
    modelo_fuente = models.CharField(max_length =50, null=False, blank=False, verbose_name= "Modelo Fuente")
    capacidad_fuente= models.CharField(max_length=50, null=False, blank=False, verbose_name="Capacidad Fuente")
    id_activo_hardware= models.OneToOneField("TipoActivo", verbose_name=_("id_activo_hardware"), on_delete=models.CASCADE, related_name="id_activo_hardware")
    

            
    class Fuente(models.Model):
        capacidad = models.CharField(max_length =50, null=False, blank=False, verbose_name= "capacidad")
        
    class Procesador(models.Model):
        marca = models.CharField(max_length =50, null=False, blank=False, verbose_name= "marca")
        generacion = models.CharField(max_length =50, null=False, blank=False, verbose_name= "generacion")
    ...
    class DiscoDuro1(models.Model):
        marca = models.CharField(max_length =50, null=False, blank=False, verbose_name= "marca")
        modelo = models.CharField(max_length =50, null=False, blank=False, verbose_name= "modelo")
        capacidad = models.CharField(max_length =50, null=False, blank=False, verbose_name= "capacidad")
        
    class DiscoDuro2(models.Model):
        marca = models.CharField(max_length =50, null=False, blank=False, verbose_name= "marca")
        modelo = models.CharField(max_length =50, null=False, blank=False, verbose_name= "modelo")
        capacidad = models.CharField(max_length =50, null=False, blank=False, verbose_name= "capacidad")

    class UnidadCd(models.Model):
        marca = models.CharField(max_length =50, null=False, blank=False, verbose_name= "marca")
        modelo = models.CharField(max_length =50, null=False, blank=False, verbose_name= "modelo")
    ...
    class TarjetaSonido(models.Model):
        marca = models.CharField(max_length =50, null=False, blank=False, verbose_name= "marca")
        modelo = models.CharField(max_length =50, null=False, blank=False, verbose_name= "modelo")
    
    class RamSlot1(models.Model):
        marca = models.CharField(max_length =50, null=False, blank=False, verbose_name= "marca")
        modelo = models.CharField(max_length =50, null=False, blank=False, verbose_name= "modelo")
        capacidad = models.CharField(max_length =50, null=False, blank=False, verbose_name= "capacidad")
    
    class RamSlot2(models.Model):
        marca = models.CharField(max_length =50, null=False, blank=False, verbose_name= "marca")
        modelo = models.CharField(max_length =50, null=False, blank=False, verbose_name= "modelo")
        capacidad = models.CharField(max_length =50, null=False, blank=False, verbose_name= "capacidad")
